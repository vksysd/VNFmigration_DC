 ...
 */
package org.opendaylight.cs756project.cli.commands;
...
public class Cs756projectCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Cs756projectCliTestCommand.class);
    protected final Cs756projectCliCommands service;

    public Cs756projectCliTestCommand(final Cs756projectCliCommands service) {
